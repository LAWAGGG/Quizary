...
-- 2. FORMS
-- ============================================
INSERT INTO forms (id, user_id, title, description, type, status, short_code, is_public, require_login, theme_color, banner_path, thank_you_message, timer_seconds, starts_at, ends_at, shuffle_questions, shuffle_options, submission_limit, created_at, updated_at) VALUES
(1, 1, 'Quiz Matematika - Kelas 7', 'Quiz materi aljabar dan aritmatika dasar untuk kelas 7 semester 1', 'quiz', 'published', 'MTH7A', 1, 0, '#6C5CE7', NULL, 'Terima kasih sudah mengerjakan quiz Matematika!', 1800, '2026-08-01 07:00:00', '2026-08-31 23:59:59', 1, 1, 'unlimited', NOW(), NOW()),
(2, 1, 'Quiz IPA - Sistem Tata Surya', 'Quiz tentang planet, bintang, dan sistem tata surya', 'quiz', 'published', 'IPA8B', 1, 1, '#EF4444', 'banners/tata-surya.png', 'Selamat! Kamu sudah menyelesaikan quiz IPA.', 1200, '2026-08-05 08:00:00', '2026-08-25 23:59:59', 1, 0, 'once', NOW(), NOW()),
(3, 2, 'Bahasa Inggris - Grammar', 'Latihan simple past tense dan daily routine vocabulary', 'quiz', 'draft', 'ENG9C', 1, 0, '#10B981', NULL, NULL, NULL, NULL, NULL, 0, 0, 'unlimited', NOW(), NOW()),
(4, 1, 'Survey Kepuasan Belajar', 'Survey untuk mengetahui tingkat kepuasan siswa terhadap proses belajar mengajar', 'form', 'published', 'SURV01', 1, 0, '#3B82F6', 'banners/survey-banner.png', 'Terima kasih atas masukannya!', NULL, '2026-07-20 00:00:00', '2026-12-31 23:59:59', 0, 0, 'unlimited', NOW(), NOW()),
(5, 2, 'Pendaftaran Lomba Sains', 'Formulir pendaftaran peserta lomba sains tingkat sekolah', 'form', 'published', 'SCI24', 1, 1, '#F59E0B', NULL, 'Pendaftaran berhasil! Kami akan menghubungi kamu lewat email.', NULL, '2026-07-15 00:00:00', '2026-08-20 23:59:59', 0, 0, 'once', NOW(), NOW()),
(6, 1, 'UTS Matematika - Semester Ganjil', 'Ujian Tengah Semester mata pelajaran Matematika kelas 7', 'quiz', 'published', 'UTSMTH', 1, 0, '#6C5CE7', NULL, 'Ujian telah selesai. Hasil akan diumumkan oleh guru pengampu.', 3600, '2026-09-10 07:00:00', '2026-09-10 09:00:00', 1, 1, 'once', NOW(), NOW()),
(7, 2, 'Quiz Fisika - Gerak Lurus', 'Quiz tentang GLB dan GLBB untuk kelas 8', 'quiz', 'published', 'FSK8A', 1, 1, '#3B82F6', NULL, 'Bagus! Pelajari lagi materi gerak lurus ya.', 900, '2026-08-10 10:00:00', '2026-08-30 23:59:59', 0, 1, 'unlimited', NOW(), NOW()),
(8, 2, 'Kuesioner Minat & Bakat', 'Pendataan minat dan bakat siswa untuk kegiatan ekstrakurikuler', 'form', 'published', 'MNSWR', 1, 0, '#F59E0B', 'banners/minat-bakat.png', 'Data kamu sudah tersimpan!', NULL, '2026-07-01 00:00:00', '2026-09-30 23:59:59', 0, 0, 'once', NOW(), NOW());
